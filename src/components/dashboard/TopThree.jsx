...
const TopThree = () => {
    return(
        ...
        <div className='w-1/3 text-white bg-gray-900 border-2 border-pink-accent h-44 rounded-xl py-3 px-2 flex flex-col justify-between'>
        ...
        <div className='w-1/3 bg-zinc-500 h-44 rounded-xl py-3 px-2 flex flex-col justify-between'>
