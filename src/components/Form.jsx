...
const Form = () => {
  ...
  return (
   <main className='w-full h-full rounded-tl-3xl bg-white py-4 px-4  overflow-auto flex flex-col items-start justify-center gap-8'>
    ...
    <form action="" className='flex flex-col w-full gap-4 p-4'>
      ...
      <button type='submit' className='text-xl py-3 px-9 text-white text-opacity-90 rounded-xl bg-background w-max hover:scale-105 duration-300 hover:border-pink-primary border-[4px] border-background'>log in</button>
    </form>
    </section>
   </main>
  )
