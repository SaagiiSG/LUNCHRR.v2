 ...
 function Logout(){
  return(
    ...
    <form action="" className='flex flex-col w-full gap-4 p-4'>
      ...
      <button type='submit' className='text-xl py-2 px-9 text-white text-opacity-90 rounded-xl bg-background w-max hover:scale-105 duration-300 hover:border-pink-primary border-[4px] border-background'>log out</button>
    </form>
    </section>
  )
 }
