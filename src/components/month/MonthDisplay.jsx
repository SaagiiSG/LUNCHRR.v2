...
const MonthDisplay = ({month , date , totalMeal, totalPayment, avaragePerson}) => {
    ...
    return(
        <div className='w-[32%] flex flex-col border-pink-accent border-2 rounded-2xl px-3 py-2'>
           ...
           className='relative w-10 aspect-square flex justify-center items-center rounded-xl bg-background bg-opacity-10 hover:bg-opacity-15 duration-300 group'>
